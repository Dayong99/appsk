<template>
	<view>
		<!-- <view v-if="persona==1"> -->
		<view class="homehead" style="margin-top: -50rpx;">
			<image style="z-index: 997;position: relative;
						width: 750rpx;" class="img" src="../../static/my/backgroundImg.png"></image>
			<view @click="goBack">
				<image style="z-index: 998;position: absolute;
						margin-top: -382rpx;
						margin-left: 40rpx;
						width: 50rpx;
						height: 50rpx;" class="imgBack" src="../../static/workbench/goBack.png">
				</image>
			</view>
			<view @click="goback"
				style="position: relative; text-align: center;margin-top: -395rpx;z-index: 999;color: #ffffff;font-weight:bold">
				积分榜单
			</view>
			<view class="posia cwhite boxscre fcenter posi292" style="z-index: 999;">
		...
		<!-- <view class="scored br10r cwhite fcenter bshow flexr-jsa mauto z100 bgwhite posia" style="z-index: 1000;">
			<view>
		...
		<view class="operation br10r bgwhite mauto mt28r" style="z-index: 1000;margin-top: -150rpx;position: relative;">
					...
					<view v-for="(item,index) in punishListData" :key="index" class="flex userwh">
						...
						<view class="detailfient">
							<view class="flex mt37r">
								<view class="wh7835 sw f22r cwhite mt5r fcenter" style="background: #B0B0B0;">
									{{item.drawStatus_dictText}}
								</view>
			...
			upCallback(mescroll) {
				getUserViolationList({
					...
					if (mescroll.num == 1) {
						...
						this.$store.commit('common/setPunishListData', this.punishListData.concat(violaRes.data
							.result.records))
					}
