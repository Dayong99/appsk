		...
		<view style="position: fixed;z-index: 100;overflow: hidden;background-color: #FFFFFF;width: 750rpx;">
			<view style="position: relative;top:0;bottom: 0;z-index: 999;height:100%;background-color: #E8E8E8;">
				<view class="head flex mauto cwhite sw f34r">
					...
					<view class="safe fcenter">视频列表</view>
					<view style="position: absolute; margin-left: 670rpx;margin-top: 5rpx;">
						<image style="width: 37rpx; height: 37rpx;" src="../../static/reservoirSum/search.png"
							@click="searchVideo"></image>
					</view>
				</view>
			</view>
		</view>
		<view style="padding-top: 160rpx;margin-left: 35rpx;">
			<view
				style="border-radius: 15rpx; padding: 45rpx 20rpx; width: 640rpx;height: 520rpx; margin-top: 20rpx;display: flex;flex-direction: column;justify-content: center; background-color: #FFFFFF;">
				<!-- <mescroll-uni @down="" @up="" :top="330" @init=""> -->
				<view>
					<image style="position: absolute; width: 640rpx;height: 400rpx;"
						src="../../static/workbench/videoCover.png"></image>
					<image @click="goVideo"
						style="position: relative; width: 80rpx;height: 80rpx;top: 150rpx;left: 270rpx;"
						src="../../static/workbench/play.png"></image>
				</view>
				<view style="margin-top: 330rpx; display: flex;flex-direction: row;padding: 0rpx 0rpx 10rpx 0rpx;">
					<view
						style="background-color: #E7541E;padding:5rpx 5rpx 0rpx 5rpx;border-radius: 6rpx;color: #FFFFFF;font-size: 25rpx;">
						未观看</view>
					<view
						style="padding:0 5rpx;font-weight: bold;white-space: nowrap;text-overflow: ellipsis;overflow: hidden;width: 500rpx;">
						中国是怎么修建水利大坝的？机器从空中运过去，还以为是特效</view>
				</view>
				<view style="display: flex;flex-direction: row;justify-content: space-between;padding-top: 5rpx;">
					<view style="display: flex;flex-direction: row;font-size: 28rpx;color: #979BA4;">
						<view>观看该视频可获取</view>
						<view>+3分</view>
					</view>
					<view style="font-size: 28rpx;color: #979BA4;">上传人：张三</view>
				</view>
				<view style="font-size: 28rpx;color: #979BA4;padding-top: 5rpx;">2020-12-5 12:16:19</view>
			</view>
		</view>
		...
		methods: {
			...
			searchVideo() {
				uni.navigateTo({
					...
					如果写相对路径，手机端是不能跳转的*/
					url: "/pages/workbench/searchVideo"
				})
			},
			toDetail() {
				console.log("ssssss")
