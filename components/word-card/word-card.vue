<template>
	<view class="br8r mtb18r mlr18r bgwhite" style="overflow: hidden;">
		<image class="word-cover" @tap="$emit('click',infoData)"
		...
		<view class="ptb18r plr18r">
			...
			<view class="flex flex-aic">
				<user-avatar @click="$emit('user',infoData.User)"
				...
				<text class="f28r c555 ml18r flex-fitem"
					@tap="$emit('click',infoData)">{{infoData.User.NickName}}</text>
