...
export async function getUserAtteUserList(params = {
  ...
  pageNo: 1,
  pageSize: 20,
  id:'1341952398426316801',
  token:"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MDg3ODM1MjQsInVzZXJuYW1lIjoiMTc1NDkyMDY5MjAifQ.wyYJqzvEwGbLB1Lfy_MoYRd2xe3NU7Y3mcEdch9KLaU"
}) {
  return await request('/stpe/article/list', 'get', params)
}

// 视频列表查询
export async function getUserVideoList(params = {
  // userid: 985319,
  pageNo: 1,
  pageSize: 20
}) {
  return await request('/stpe/video/list', 'get', params)
}
...
export async function bankList(params={
  ...
  return await request('/stpe/examination/list', 'get', params)
}
// 加分
export async function AddScore(params) {
  return await request('/stpe/revpay/add', 'post', params)
}
/**
 * 用户关注添加
