	...
	<view class="uni-date">
		...
		'uni-date-x--border': border}">
			...
			<view v-else class="uni-date-x uni-date-range" @click="show">
				...
				<view class="uni-date__icon-logo">
					<image class="uni-date-editor--logo" src="../../static/rilitime.png" mode=""></image>
				</view>
				<slot>
					<view style="margin-left: 20rpx;">{{rangeSeparator}}</view>
				</slot>
				<input class="uni-date__input uni-date-range__input" style="margin-left: 29rpx;" type="text" v-model="range.endDate"
